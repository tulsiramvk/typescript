...
const LotteryCard = (props) => {
  ...
  return (
    <LinearGradient start={{ x: 0, y: 0.5 }} end={{ x: 1, y: 0 }} colors={["#0C213C", "#0A274B", "#083B79"]} style={[{ borderRadius: 6, borderWidth: 0.3, borderColor: colors.blue, marginBottom: 25 }]} >
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10 }}>
        ...
        <View style={[styles.block2]}>
          <Text allowFontScaling={false} style={[styles.cardText]}>{d.name}</Text>
